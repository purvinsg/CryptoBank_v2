        ...
        <div class="mt-5 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="py-4 px-8 sm:px-6 lg:px-6 bg-white overflow-hidden shadow-md sm:rounded-lg overflow-x-auto">
                <p class="text-center text-gray-600">
                    Manage your crypto portfolio with ease on our intuitive Crypto Portfolio page.
                    Track the cryptocurrencies you own and monitor their performance in real-time.
                    View your transaction history, including both buying and selling activities, to keep a detailed record of your trades.
                    With our powerful search functionality, quickly find specific transactions within your portfolio.
                    Stay organized, informed, and in control of your crypto investments with our Crypto Portfolio page,
                    empowering you to make strategic decisions and optimize your crypto holdings.
                </p>
            </div>
        </div>
        <div class="py-12">
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg">
                    <table class="w-full whitespace-nowrap">
                        ...
                        <tr v-for="(crypto, index) in cryptos" :key="crypto.id"
                            ...
                            <div class="ml-2 pb-2 pt-2 px-8 py-2"></div>
                        </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="mt-5 bg-white overflow-hidden shadow-md sm:rounded-lg">
                    <table class="w-full whitespace-nowrap">
                        ...
                        <tr class="text-left font-bold">
                            ...
                            <th class="pb-4 pt-6 px-6">Name</th>
                            <th class="pb-4 pt-6 px-6">Amount</th>
                            <th class="pb-4 pt-6 px-6">Crypto price</th>
                        ...
                        <tr v-for="transaction in transactions.data" :key="transaction.id"
                            :class="transaction.type === 'buy' ? 'text-green-800' : 'text-red-800'">
                            <td class="border-t">
