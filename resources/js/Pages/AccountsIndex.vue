        ...
        <div class="mt-5 max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="py-4 px-8 sm:px-6 lg:px-6 bg-white overflow-hidden shadow-md sm:rounded-lg overflow-x-auto">
                <p class="text-center text-gray-600">
                    Discover the power of your Account Overview page!
                    Easily manage and update your account details, track transactions effortlessly,
                    and gain valuable insights into your financial status.
                    Stay in control of your finances, explore transaction history, and make informed decisions with confidence.
                    Experience the convenience and simplicity of managing your accounts all in one place.
                </p>
            </div>
        </div>
        <div class="py-12">
            ...
            <div class="mt-5 max-w-7xl mx-auto sm:px-6 lg:px-8">
                <TransactionFilter
                    ...
                    searchOnePlaceholder="Search by account number..."
                    searchTwoPlaceholder="Search by user name..."
                    @reset="resetFilters"
                ...
                <div class="bg-white overflow-hidden shadow-md sm:rounded-lg overflow-x-auto">
                    <table class="w-full whitespace-nowrap">
                        ...
                        <tr v-for="transaction in transactions.data" :key="transaction.id"
                            :class="transaction.recipient_account.user.id === $page.props.user.id ? 'text-green-800' : 'text-red-800'">
                            <td class="border-t">
                                <div class="flex items-center px-6 py-4">
                                    {{ transaction.id }}
                                </div>
