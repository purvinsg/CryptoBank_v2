...
<template>
    <div>
        <button v-if="as == 'button'" type="submit" class="block w-full px-4 py-2 text-sm leading-5 text-gray-700 text-left hover:bg-gray-200 focus:outline-none focus:bg-gray-100 transition">
            <slot />
        </button>
